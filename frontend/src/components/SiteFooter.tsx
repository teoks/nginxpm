				...
				<div className="row text-center align-items-center flex-row-reverse">
					...
					<div className="col-12 col-lg-auto mt-3 mt-lg-0">
						<ul className="list-inline list-inline-dots mb-0">
							<li className="list-inline-item">
								© 2026{" "}
								<a href="https://altvirt.com" rel="noreferrer" target="_blank" className="link-secondary">
									altvirt.com
								</a>
							</li>
							<li className="list-inline-item">
							...
							<li className="list-inline-item">
								<a
									href={`https://github.com/teoks/nginxpm/releases/tag/${getVersion()}`}
									className="link-secondary"
									target="_blank"
									rel="noopener"
								>
							...
							{versionData?.updateAvailable && versionData?.latest && (
								<li className="list-inline-item">
									<a
										href={`https://github.com/teoks/nginxpm/releases/tag/${versionData.latest}`}
